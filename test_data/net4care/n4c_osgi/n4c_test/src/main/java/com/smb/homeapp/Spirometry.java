...
/** A demonstration implementation of the ObservationSpecifics 
 * interface for spirometry values coded using the LOINC system. 
 *  
 * Note that this class is only known on the client's side 
 * it is not used or known on the server side. 
 *  
